...
const THEME_13: ManualReadinessEntry[] = [
  ...
  },
  {
    ...
    specializedResolvers: ["computeEconomySemanticSafe"],
    missingCapabilities: [],
    evidence: [{ file: ECON_FILE, symbol: "ECONOMY_FEATURE_FAMILY_MANIFEST" }],
    notes: "knownTxTypes/publicLog/type数ではなく、明示review対象のstable semantic family（peer_transfer/tip/shop）を数える。underlying actionが同familyで複数あってもfamily breadthは1。",
    blockerKinds: ["none"],
    optimizationRisk: "LOW",
  },
  {
