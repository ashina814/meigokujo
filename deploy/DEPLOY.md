...
9. 一時worktreeを削除
10. 反映前DBバックアップを作成
11. 本番mainを取得済みSHAへ`--ff-only`で反映
12. 本番の依存関係を`--frozen-lockfile`で同期
13. 反映後も作業ツリーがcleanか確認
14. `meigokujo-bot.service`を再起動
15. service状態と再起動後journalを表示
16. serviceが引き続きactiveか再確認
17. 成功したSHAを`/home/kabu/.meigokujo-deployed-sha`へ記録
18. 反映前・取得先・反映後SHAを表示
